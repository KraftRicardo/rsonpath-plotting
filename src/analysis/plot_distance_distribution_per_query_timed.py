...
if __name__ == "__main__":
    # Input
    data_dir_path = "res/data/analysis/distance_distribution_per_query/track_timed/rq_lut_no_lut"
    result_dir_path = "res/plots/analysis/distance_distribution_per_query/track_timed/rq_lut_no_lut"
